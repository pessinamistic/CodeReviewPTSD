...
public class CarDisplayService implements DisplayService {
  ...
  public void getFreeCount(String parkingLotName) {
    ...
    for (BitSet bitSet : availableSlots) {
      ...
      System.out.println("No of free slots for CAR on floor " + (floor++) + ": " + freeCount);
      freeCount = 0;
    }
  }
  ...
  public void getFreeSlots(String parkingLotName) {
    ...
    for (BitSet bitSet : availableSlots) {
      ...
      System.out.println(
          "Free slots for CAR on Floor " + (floor++) + ": " + returnString.trim().replace(" ", ","));
    }
  }
  ...
  public void getOccupiedSlots(String parkingLotName) {
    ...
    for (BitSet bitSet : availableSlots) {
      ...
      System.out.println(
          "Occupied Occupied  slots for CAR on Floor "
              + (floor++)
              + ": "
